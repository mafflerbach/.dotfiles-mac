...
main = do 
        ...
        xmproc0 <- spawnPipe "xmobar -x0 /home/maren/.config/xmobar/xmobarrc0 -A 200"
        xmproc1 <- spawnPipe "xmobar -x1 /home/maren/.config/xmobar/xmobarrc1 -A 200"
        xmproc2 <- spawnPipe "xmobar -x2 /home/maren/.config/xmobar/xmobarrc2 -A 200"
      ...
      -- hooks, layouts
        ...
        logHook = myLogHook <+> dynamicLogWithPP xmobarPP
                      ...
                      --  , ppSep =  "|"          -- Separators in xmobar
                        , ppUrgent = xmobarColor "COLOR9" "" . wrap "!" "!"  -- Urgent workspace
