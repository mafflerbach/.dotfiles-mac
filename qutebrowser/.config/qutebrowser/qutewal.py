...
if os.path.isfile(colors_absolute):
    ...
    # Type: QssColor
    c.colors.statusbar.insert.fg = "#999999"
    ...
    # Type: QssColor
    c.colors.statusbar.url.fg ="#00000000"
    ...
    # Type: QtColor
    c.colors.tabs.bar.bg = "#00ff00ff"

    # Background color of unselected even tabs.
    # Type: QtColor
    c.colors.tabs.even.bg ="#00ff0000"
