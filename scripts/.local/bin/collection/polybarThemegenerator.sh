...
#foreground = FGCOLOR
#foreground-alt = FGCOLOR

sed -e "s/BGCOLOR/#$background/g" \
    -e "s/FGCOLOR/$foreground/g" \
    /home/maren/.dotfiles/polybar/.config/polybar/colors-template.ini > /home/maren/.dotfiles/polybar/.config/polybar/colors-template2.ini
...
sed -e "s/##/#44/g" \
    ...
    /home/maren/.dotfiles/polybar/.config/polybar/colors-template2.ini > /home/maren/.config/polybar/colors.ini
